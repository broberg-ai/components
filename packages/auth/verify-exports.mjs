// Build-time seal (F008.8): fail the build if any file referenced by
// package.json "exports" is missing from dist. This catches the tsup
// multi-config clean race that dropped hono.d.ts/hono.d.cts from the 0.1.2
// build — a missing types file now blocks `pnpm build` (and thus the publish
