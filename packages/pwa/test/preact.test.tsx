...
import { render, screen, fireEvent, cleanup, renderHook } from "@testing-library/preact";
import { PwaUpdateBanner, usePwaUpdate } from "../src/preact.js";

afterEach(cleanup);

describe("PwaUpdateBanner (preact)", () => {
